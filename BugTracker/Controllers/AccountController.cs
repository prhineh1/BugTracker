    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model,  HttpPostedFileBase profilePic)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.Email, FirstName = model.FirstName, LastName = model.LastName, Email = model.Email, profilePic = model.profilePic };
                ...
                if (result.Succeeded)
                {
                    ...
                    var newUser = db.Users.FirstOrDefault(u => u.Email == model.Email);
                    if (roleHelper.UserWithNoRole(newUser))
                    {
                        roleHelper.NoRoleAlert(newUser);
                    }
        ...
        public ActionResult ConfrimationSent()
        {
            return View();
        }
